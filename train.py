class Opion():
    ...
    def __init__(self):
        ...
        self.dataroot= '../img_celeba_mini/' #image dataroot
        self.maskroot= '../irregular_mask/disocclusion_img_mask/'#mask dataroot
        self.batchSize= 4   # Need to be set to 1
...
def main():
    ...
    for epoch in range(opt.epoch_count, opt.niter + 1):  # opt.niter_decay + 1):
